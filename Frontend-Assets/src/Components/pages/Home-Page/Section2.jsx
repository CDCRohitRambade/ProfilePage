			...
			<section className="text-gray-600 body-font">
				<div className="sm:container px-3 py-5 mx-auto">
					<div className="text-center mb-3">
						...
						<p className="leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-lg text-center">
					...
					<div className="flex flex-col items-center justify-around md:flex-row  mb-10">
						<div className="flex items-center">
							<div className="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0">
								<Link to="/sign-in">
									<div className="relative inline-flex items-center justify-center p-4 px-6 py-2 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-lg shadow-md group w-[130px]">
					...
					<div className="flex flex-wrap -m-4">
						...
						<div className="xl:w-1/3 md:w-1/2 p-4">
							<div className="border border-gray-200 p-6 rounded-lg">
								...
								<a
									...
									<span className="absolute  rounded-lg inset-0 w-full h-full bg-white border-2 border-[#8800ff] group-hover:bg-[#8800ff]"></span>
									<span className="relative text-black group-hover:text-white flex items-center justify-center">
										Join Now
										<svg
											xmlns="http://www.w3.org/2000/svg"
						...
						<div className="xl:w-1/3 md:w-1/2 p-4 ">
							<div className="border border-gray-200 p-6 rounded-lg">
								...
								<h2 className="text-lg text-gray-900 font-medium title-font mb-2">
									Startup & Entrepreneurship Community
								</h2>
								<p className="leading-relaxed text-base mb-2">
