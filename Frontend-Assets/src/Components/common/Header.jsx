				...
				<div className="lg:hidden flex gap-2 items-center">
					{!currentUser && (
						<div
							type="button"
							onClick={() => setShow(!show)}
							className="relative flex justify-center items-center  mr-1 rounded-md px-2 py-1 text-[12px] h-8  font-normal bg-transparent text-black border-2 border-black  hover:border-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">
							Join <MdOutlineVerified className=" inline-block h-4 w-4 ml-1" />
							{show && <QuickBox Options={authData} side={"right"} />}
						</div>
					)}
					{currentUser && (
