...
const ContactUs = () => {
	return (
		<div className="bg-[#FEFEFA]">
			<div className="max-w-6xl mx-auto bg-white my-6 font-poppins text-[#011c2b]">
				...
				<div className="grid lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8">
					<div className="bg-[#6F00FF] rounded-lg p-6 max-lg:text-center">
						<h2 className="text-xl font-normal text-white">
							Contact Information
						</h2>
						<p className="text-sm text-white mt-3">
							Have some questions on how woes It work? Please Reach Out To Us,
						...
						<ul className="mt-16 space-y-10">
							<li className="flex items-center max-lg:justify-center">
								...
								<a href="#" className="text-white text-sm ml-3">
									<strong>admin@inspirationapp.org</strong>
								</a>
							</li>
							<li className="flex items-center max-lg:justify-center">
								<svg
						...
						<ul className="flex max-lg:justify-center mt-16 space-x-4">
							<li className="bg-white hover:bg-[#F7F7F7] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
								<a href="#">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										width="18px"
						...
						<form>
							<div className="grid sm:grid-cols-2 gap-8">
								...
								<div className="col-span-full">
									<h6 className="text-sm text-gray-400">Select Category</h6>
									<div className="flex max-lg:flex-col lg:space-x-6 max-lg:space-y-6">
										<div className="flex items-center mt-3">
											...
											<p className="text-sm ml-3">Technology</p>
										</div>
										<div className="flex items-center mt-3">
											<input
												id="radio2"
											...
											<p className="text-sm ml-3">Spirituality</p>
										</div>
										<div className="flex items-center mt-3">
											<input
												id="radio3"
											...
											<p className="text-sm ml-3">Health & Fitness</p>
										</div>
										<div className="flex items-center mt-3">
											<input
												id="radio4"
											...
											<p className="text-sm ml-3">Buisness</p>
										</div>
										<div className="flex items-center mt-3">
											<input
												id="radio5"
											...
											<p className="text-sm ml-3">Juniors</p>
										</div>
									</div>
								</div>
							</div>
							<button
								type="button"
								className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-[#6F00FF] text-white hover:bg-[#6400FF]">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="16px"
									height="16px"
